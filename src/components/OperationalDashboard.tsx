...
export default function OperationalDashboard({ onLogout }: OperationalDashboardProps) {
  ...
  const renderOverview = () => (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <motion.div whileHover={{ y: -4 }} className="md:col-span-2 portal-card p-8 flex flex-col lg:flex-row gap-8 items-center relative overflow-hidden group">
           <div className="flex-1 relative z-10">
              <div className="w-14 h-14 bg-accent/10 text-accent rounded-2xl flex items-center justify-center mb-6 border border-accent/20 shadow-lg shadow-accent/10">
                <TrendingUp className="w-7 h-7" />
              </div>
              <h4 className="font-headline text-3xl font-bold text-white tracking-tight mb-3">Overall Progress Pekerjaan</h4>
              <p className="text-sm text-text-dim font-medium mb-8 leading-relaxed opacity-80 max-w-md">
                Ringkasan akumulasi seluruh progress pekerjaan teknis dan administratif.
              </p>
           ...
           <div className="w-full lg:w-2/5 portal-card bg-slate-950/40 p-6 flex flex-col justify-between relative z-10 border border-white/5 h-full min-h-[280px]">
              <div className="flex justify-between items-start">
                 <h5 className="text-[10px] font-bold text-text-dim uppercase tracking-widest">Trend</h5>
                 <TrendingUp className="w-4 h-4 text-emerald-400" />
              </div>
              {/* Smooth Line Chart with Glow */}
              <div className="flex-1 relative my-6 min-h-[100px] group/chart">
                <svg viewBox="0 0 400 120" className="w-full h-full overflow-visible">
                  ...
                  <motion.path
                    ...
                    strokeWidth="3"
                    style={{ filter: "drop-shadow(0 0 12px rgba(190, 242, 100, 0.4))" }}
                  />
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-8 flex flex-col justify-between group overflow-hidden">
           <div>
             <div className="w-14 h-14 bg-accent-light/10 text-accent-light rounded-2xl flex items-center justify-center mb-6 border border-accent-light/20">
                <Calendar className="w-7 h-7" />
             </div>
             <h4 className="font-headline text-2xl font-bold text-white tracking-tight mb-3">Jadwal Lapangan</h4>
             <p className="text-sm text-text-dim font-medium leading-relaxed opacity-80">
                Lokasi penugasan dan waktu inspeksi terbaru minggu ini.
             </p>
           </div>
           <div className="mt-8">
              <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-6 flex flex-col h-full group">
          <div className="flex justify-between items-center mb-6">
            <span className="text-[10px] font-bold text-text-dim uppercase tracking-widest">Performance</span>
          ...
          <div className="flex-1 flex items-center justify-center py-2">
             ...
             <div className="relative w-28 h-28 flex items-center justify-center">
                <svg className="w-full h-full -rotate-90">
                   <circle cx="56" cy="56" r="48" className="fill-none stroke-white/5 stroke-[6]" />
                   <motion.circle 
                     cx="56" cy="56" r="48" 
                     className="fill-none stroke-accent stroke-[6]"
                     strokeDasharray="301.6"
                     initial={{ strokeDashoffset: 301.6 }}
                     animate={{ strokeDashoffset: 301.6 * (1 - 0.74) }}
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-6 flex flex-col h-full group">
           <div className="flex justify-between items-center mb-6">
            <span className="text-[10px] font-bold text-text-dim uppercase tracking-widest">Workload</span>
          ...
          <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
             ...
             <span className="text-[9px] font-bold text-white uppercase tracking-widest px-2 py-0.5 rounded bg-accent/10 border border-accent/20">Optimal</span>
          </div>
        </motion.div>
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-6 flex flex-col h-full group">
           <div className="flex justify-between items-center mb-6">
            <span className="text-[10px] font-bold text-text-dim uppercase tracking-widest">Weekly</span>
            <div className="p-2 bg-emerald-400/5 rounded-lg border border-emerald-400/10">
               <CheckCircle className="w-3 h-3 text-emerald-400" />
            </div>
          </div>
          <div className="flex-1 flex items-end gap-2 justify-between pb-1 px-1">
          ...
          <div className="mt-6 pt-6 border-t border-white/5">
             <div className="flex items-center gap-2.5">
                <div className="p-1.5 bg-emerald-400/10 rounded border border-emerald-400/20">
                   <Plus className="w-2.5 h-2.5 text-emerald-400" />
                </div>
                <div>
                   <p className="text-[9px] font-bold text-text-dim uppercase">Peak Productivity</p>
                   <p className="text-xs font-bold text-white">Friday <span className="text-text-dim font-medium text-[9px] ml-1">90% Rate</span></p>
                </div>
             </div>
          </div>
        </motion.div>
  ...
  const renderProgress = () => (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Dokumen Proper */}
        <motion.div whileHover={{ y: -4 }} className="portal-card p-8 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 rounded-bl-full pointer-events-none"></div>
          <div className="flex justify-between items-start mb-6">
            <div>
              <span className="text-[10px] font-bold text-accent uppercase tracking-[0.2em] mb-1.5 block">Document Category</span>
              <h4 className="font-headline text-2xl font-bold text-white tracking-tight">Dokumen Proper</h4>
            </div>
          ...
          <div className="flex items-end gap-5 mb-6">
            <div className="font-headline text-5xl font-bold text-white tracking-tighter">72%</div>
            <div className="mb-1.5">
              <span className="text-lg font-bold text-white/80">45 <span className="text-text-dim text-xs">/ 62</span></span>
              <p className="text-[9px] font-bold text-text-dim uppercase tracking-widest mt-0.5">Files Completed</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-[9px] font-bold uppercase tracking-widest text-text-dim">
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-accent"></div>
                <span>Sync Active</span>
              </div>
              <span className="text-accent-light opacity-60">2h ago</span>
            </div>
          </div>
        </motion.div>

        {/* Dokumen Non-Proper */}
        <motion.div whileHover={{ y: -4 }} className="portal-card p-8 relative overflow-hidden group border-amber-500/20">
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-bl-full pointer-events-none"></div>
          <div className="flex justify-between items-start mb-6">
            <div>
              <span className="text-[10px] font-bold text-amber-500 uppercase tracking-[0.2em] mb-1.5 block">Priority Category</span>
              <h4 className="font-headline text-2xl font-bold text-white tracking-tight">Dokumen Non-Proper</h4>
            </div>
          ...
          <div className="flex items-end gap-5 mb-6">
            <div className="font-headline text-5xl font-bold text-white tracking-tighter text-shadow-glow">48%</div>
            <div className="mb-1.5">
              <span className="text-lg font-bold text-white/80">14 <span className="text-text-dim text-xs">/ 29</span></span>
              <p className="text-[9px] font-bold text-text-dim uppercase tracking-widest mt-0.5">Files Verified</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-[9px] font-bold uppercase tracking-widest text-text-dim">
              ...
              <span className="text-amber-200/50 opacity-60">5h ago</span>
            </div>
          </div>
        </motion.div>
      </div>

      {/* Section 2: Overall Summary - Integrated Header */}
      <div className="portal-card p-8">
        <div className="flex items-center gap-4 mb-6">
           <h3 className="font-headline text-xl font-bold text-white tracking-tight whitespace-nowrap">Overall Summary</h3>
           <div className="h-px bg-white/5 flex-1"></div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { label: "Overall Progress", val: "64.5%", icon: TrendingUp, trend: "+4.2%", color: "text-accent" },
            { label: "Beban Teknis", val: "148h", icon: BarChart3, trend: "Stable", color: "text-blue-400" },
            { label: "Dokumen Diampu", val: "91", icon: Layers, trend: "+5 new", color: "text-emerald-400" },
            { label: "Dokumen Selesai", val: "59", icon: CheckCircle, trend: "65% Rate", color: "text-purple-400" },
          ].map((stat, i) => (
            <div key={i} className="p-4 rounded-3xl bg-white/[0.02] border border-white/5 group hover:bg-white/[0.04] transition-all">
              <div className="flex justify-between items-start mb-4">
                <div className={`p-2 rounded-lg bg-white/[0.03] border border-white/5 ${stat.color}`}>
                  <stat.icon className="w-4 h-4" />
                </div>
                <span className={`text-[8px] font-bold px-1.5 py-0.5 rounded bg-white/5 border border-white/10 uppercase tracking-widest ${stat.trend.includes('+') ? 'text-emerald-400' : 'text-text-dim'}`}>
                  {stat.trend}
                </span>
              </div>
              <p className="text-[9px] font-bold text-text-dim uppercase tracking-widest mb-1">{stat.label}</p>
      ...
      <div className="portal-card p-8 overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <h3 className="font-headline text-xl font-bold text-white">Company Progress Hub</h3>
            <p className="text-sm text-text-dim mt-0.5">Real-time status synchronization monitoring.</p>
          </div>
          <div className="flex gap-3">
             <div className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-xl flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-400"></div>
                <span className="text-[9px] font-bold text-white uppercase tracking-widest opacity-60">34 On Track</span>
             </div>
             <div className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-xl flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-amber-400"></div>
                <span className="text-[9px] font-bold text-white uppercase tracking-widest opacity-60">12 Delayed</span>
             </div>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-white/5 bg-white/[0.01]">
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest first:rounded-tl-xl">Perusahaan</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest">Data Diterima</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest">Progress</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest">Status</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest text-right last:rounded-tr-xl">Action</th>
              </tr>
            </thead>
            <tbody className="text-sm font-medium">
              {[
                ...
                <tr key={i} className="border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-all group">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2.5">
                      <div className="w-7 h-7 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-accent font-bold text-xs">
                        {row.name[0]}
                      </div>
                  ...
                  <td className="py-4 px-4">
                    <div className="flex justify-between items-center gap-2 max-w-[80px]">
                      <span className="text-[10px] text-text-dim font-bold">{row.received}%</span>
                  ...
                  <td className="py-4 px-4">
                    <div className="flex justify-between items-center gap-2 max-w-[80px]">
                      <span className="text-[10px] text-white font-bold">{row.progress}%</span>
                      <div className="flex-1 h-0.5 bg-white/5 rounded-full overflow-hidden">
                  ...
                  <td className="py-4 px-4 text-right">
                    <button 
                      ...
                      className="px-3 py-1 bg-accent/10 border border-accent/20 rounded-lg text-accent text-[9px] font-bold uppercase tracking-widest hover:bg-accent hover:text-bg-deep transition-all"
                    >
                      View
                    </button>
                  </td>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-12">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-3xl glass shadow-2xl rounded-[32px] overflow-hidden flex flex-col max-h-[85vh] border border-white/10"
            >
              {/* Modal Header */}
              <div className="p-6 pb-2 flex justify-between items-start">
                <div className="flex gap-4 items-center">
                  <div className="w-12 h-12 rounded-2xl bg-accent flex items-center justify-center text-bg-deep">
                    <BarChart3 className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white tracking-tight">{selectedCompany?.name}</h3>
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="text-[9px] font-bold text-accent uppercase tracking-widest">Detail Checklist</span>
                      <div className="w-1 h-1 rounded-full bg-white/20"></div>
                      <span className="text-[9px] font-bold text-text-dim uppercase tracking-widest">ID: {Math.random().toString(36).substr(2, 6).toUpperCase()}</span>
                    </div>
                  </div>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
                  className="p-2 bg-white/5 border border-white/10 rounded-xl text-text-dim hover:text-white transition-all hover:bg-white/10"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="portal-card p-5 border-l-4 border-accent">
            <div className="flex items-center gap-3 mb-3">
              <item.icon className="w-4 h-4 text-accent opacity-50" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 portal-card p-8">
          <h3 className="font-headline text-xl font-bold text-white mb-1">Weekly Schedule</h3>
          <p className="text-sm text-text-dim mb-8">Your assigned locations and activities.</p>
          
          <div className="space-y-3">
            {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].map((day, i) => (
              <div key={day} className={`flex items-center justify-between p-4 rounded-2xl border border-white/5 ${i === 0 ? 'bg-accent/5 border-accent/20' : 'bg-white/[0.02]'}`}>
                <div className="flex items-center gap-5">
                  <div className="w-10 text-center">
                    <span className="block text-[9px] font-bold text-text-dim uppercase">{day.slice(0, 3)}</span>
                    <span className={`text-lg font-bold ${i === 0 ? 'text-accent' : 'text-white'}`}>{12 + i}</span>
                  </div>
                  <div>
                    <h5 className="font-bold text-white text-sm">Area Inspection & Sampling</h5>
                    <p className="text-[10px] text-text-dim">Sector C-04 • Team Bravo</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-[9px] font-bold text-white bg-white/5 py-1 px-2.5 rounded-lg border border-white/10 uppercase tracking-widest">
        ...
        <div className="space-y-6">
          <div className="portal-card p-6">
            <h4 className="font-headline text-lg font-bold text-white mb-5">Upcoming Team</h4>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-bold text-accent text-sm">
                      {p.name[0]}
                    </div>
                    <div>
                      <p className="text-sm font-bold text-white">{p.name}</p>
                      <p className="text-[9px] text-text-dim uppercase font-bold tracking-widest">{p.role}</p>
                    </div>
                  </div>
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-8 relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <span className="text-[10px] font-bold text-accent uppercase tracking-[0.2em] mb-1.5 block">Quality Control</span>
              <h4 className="font-headline text-2xl font-bold text-white tracking-tight">QC Proper</h4>
            </div>
            <div className="p-3 bg-accent/10 border border-accent/20 rounded-2xl text-accent">
          ...
          <div className="flex items-end gap-5 mb-6">
            <div className="font-headline text-5xl font-bold text-white tracking-tighter">84%</div>
            <div className="mb-1.5">
              <span className="text-lg font-bold text-white/80">52 <span className="text-text-dim text-xs">/ 62</span></span>
              <p className="text-[9px] font-bold text-text-dim uppercase tracking-widest mt-0.5">QC Passed</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-[9px] font-bold uppercase tracking-widest text-text-dim">
              ...
              <span className="text-accent-light opacity-60">45m ago</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div whileHover={{ y: -4 }} className="portal-card p-8 relative overflow-hidden group border-amber-500/20">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <span className="text-[10px] font-bold text-amber-500 uppercase tracking-[0.2em] mb-1.5 block">Quality Control</span>
              <h4 className="font-headline text-2xl font-bold text-white tracking-tight">QC Non-Proper</h4>
            </div>
            <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-2xl text-amber-500">
          ...
          <div className="flex items-end gap-5 mb-6">
            <div className="font-headline text-5xl font-bold text-white tracking-tighter text-shadow-glow">35%</div>
            <div className="mb-1.5">
              <span className="text-lg font-bold text-white/80">10 <span className="text-text-dim text-xs">/ 29</span></span>
              <p className="text-[9px] font-bold text-text-dim uppercase tracking-widest mt-0.5">QC Passed</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center text-[9px] font-bold uppercase tracking-widest text-text-dim">
              ...
              <span className="text-amber-200/50 opacity-60">3h ago</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="portal-card p-8 overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <h3 className="font-headline text-xl font-bold text-white">QC Company Progress</h3>
            <p className="text-sm text-text-dim mt-0.5">Reviewing formatting and technical compliance.</p>
          </div>
          <div className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-xl flex items-center gap-2">
             <div className="w-1.5 h-1.5 rounded-full bg-accent-light"></div>
             <span className="text-[9px] font-bold text-white uppercase tracking-widest opacity-60">Portal Active</span>
          </div>
        </div>
        ...
        <div className="overflow-x-auto -mx-8 px-8">
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="border-b border-white/5 bg-white/[0.01]">
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest first:rounded-tl-xl">Nama Perusahaan</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest">Progress</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest">Status</th>
                <th className="py-4 px-4 text-[9px] font-bold text-text-dim uppercase tracking-widest text-right last:rounded-tr-xl">Action</th>
              </tr>
            ...
            <tbody className="text-sm font-medium">
              {[
                ...
                <tr key={i} className="border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-all group">
                  ...
                  <td className="py-4 px-4">
                    <div className="flex justify-between items-center gap-2 max-w-[100px]">
                      <span className="text-[10px] text-white font-bold">{row.progress}%</span>
                      <div className="flex-1 h-0.5 bg-white/5 rounded-full overflow-hidden">
                        <div className="h-full bg-accent" style={{ width: `${row.progress}%` }}></div>
                      </div>
  ...
  const activeItem = [...navItems, { icon: Settings, label: "System Settings" }].find(item => item.label === currentView);
      ...
      <aside className="fixed left-6 top-6 bottom-6 w-24 sidebar-glass hidden lg:flex flex-col items-center py-10 z-40 rounded-[3rem] border border-white/5 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
        ...
        <div className="mb-14">
          <div className="w-14 h-14 bg-white/5 rounded-[1.5rem] flex items-center justify-center border border-white/10 group cursor-pointer hover:bg-accent/5 transition-all shadow-lg">
             <Leaf className="w-7 h-7 text-accent group-hover:scale-110 transition-transform" />
          </div>
        </div>

        {/* Middle Navigation Dock */}
        <nav className="flex-1 flex flex-col gap-6">
          {[...navItems, { icon: Settings, label: "System Settings" }].map((item) => (
            ...
            <>
              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  {[...navItems, { icon: Settings, label: "System Settings" }].map((item, i) => (
                    <motion.button 
                  ...
                  <motion.button 
                    initial={{ opacity: 0, x: 20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: (navItems.length + 1) * 0.05 + 0.1 }}
                    onClick={onLogout}
      ...
      <main className="lg:ml-32 flex-1 flex flex-col min-w-0 min-h-screen p-6 lg:p-8">
        <header className="glass h-[80px] rounded-3xl px-6 lg:px-10 flex justify-between items-center mb-10">
          <div className="flex items-center gap-6">
             <h2 className="font-headline text-xl lg:text-2xl font-bold text-white tracking-tight">{currentView === 'Overview' ? 'Operations Hub' : currentView}</h2>
